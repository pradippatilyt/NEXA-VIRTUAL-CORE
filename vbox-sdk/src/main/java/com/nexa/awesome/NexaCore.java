...
import com.nexa.awesome.app.LauncherActivity;
...
import com.nexa.awesome.fake.frameworks.BJobManager;
import com.nexa.awesome.fake.frameworks.BPackageManager;
import com.nexa.awesome.fake.frameworks.BStorageManager;
import com.nexa.awesome.fake.frameworks.BUserManager;
...
import com.nexa.awesome.utils.ShellUtils;
...
public class NexaCore extends ClientConfiguration {
    public static final String TAG = "NexaCore";

    private static final NexaCore sNexaCore = new NexaCore();
    ...
    public void doAttachBaseContext(Context context, ClientConfiguration clientConfiguration) {
        ...
        if (processName.equals(NexaCore.getHostPkg())) {
        ...
        if (NexaCore.get().isBlackProcess()) {
            BEnvironment.load();
        }
   ...
   public boolean launchApk(String packageName, int userId) {
    ...
    private void initNotificationManager() {
        ...
        String CHANNEL_ONE_ID = NexaCore.getContext().getPackageName() + ".blackbox_core";
