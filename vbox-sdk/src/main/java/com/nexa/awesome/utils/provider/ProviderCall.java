package com.nexa.awesome.utils.provider;
...
import com.nexa.awesome.utils.compat.ContentProviderCompat;
...
public class ProviderCall {
	public static Bundle callSafely(String authority, String methodName, String arg, Bundle bundle) {
		try {
			return call(authority, NexaCore.getContext(), methodName, arg, bundle, 5);
	...
	public static Bundle call(
		String authority, Context context, String method, String arg, Bundle bundle, int retryCount)
