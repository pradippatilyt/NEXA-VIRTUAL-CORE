...
import com.nexa.awesome.proxy.ProxyBroadcastReceiver;
            ...
            for (BPackage.Activity receiver : bPackage.receivers) {
                ...
                for (BPackage.ActivityIntentInfo intent : intents) {
                    ...
                    if (BuildCompat.isUpsideDownCake()) {
                        NexaCore.getContext().registerReceiver(proxyBroadcastReceiver, intent.intentFilter, Context.RECEIVER_NOT_EXPORTED);
                    }
            ...
            synchronized (mReceivers) {
                ...
                if (broadcastReceivers != null) {
                    ...
                    for (BroadcastReceiver broadcastReceiver : broadcastReceivers) {
                        try {
                            NexaCore.getContext().unregisterReceiver(broadcastReceiver);
