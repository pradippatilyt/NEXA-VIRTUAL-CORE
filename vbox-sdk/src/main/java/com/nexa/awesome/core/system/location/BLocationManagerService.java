package com.nexa.awesome.core.system.location;
...
import com.nexa.awesome.entity.location.BCell;
import com.nexa.awesome.entity.location.BLocation;
import com.nexa.awesome.entity.location.BLocationConfig;
    ...
    private void addTask(IBinder locationListener) {
        mThreadPool.execute(() -> {
            ...
            while (locationListener.pingBinder()) {
                ...
                NexaCore.get().getHandler().post(() -> BRILocationListener.get(iInterface).onLocationChanged(location.convert2SystemLocation()));
            }
        });
    }
