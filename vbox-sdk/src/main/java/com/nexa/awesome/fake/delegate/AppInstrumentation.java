...
import com.nexa.awesome.utils.HackAppUtils;
import com.nexa.awesome.utils.Slog;
import com.nexa.awesome.utils.compat.ActivityCompat;
...
public final class AppInstrumentation extends BaseInstrumentationDelegate implements IInjectHook {
    ...
    public void injectHook() {
        try {
            ...
            BRActivityThread.get(NexaCore.mainThread())._set_mInstrumentation(this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
