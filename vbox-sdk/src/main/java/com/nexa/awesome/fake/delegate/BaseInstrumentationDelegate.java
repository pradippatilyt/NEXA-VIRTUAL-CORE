package com.nexa.awesome.fake.delegate;
...
public class BaseInstrumentationDelegate extends Instrumentation {
    ...
    public void callActivityOnCreate(Activity activity, Bundle icicle) {
        ...
        for (AppLifecycleCallback appLifecycleCallback : NexaCore.get().getAppLifecycleCallbacks()) {
    ...
    public ActivityResult execStartActivity(Context context, IBinder binder, IBinder binder1, Activity activity, Intent intent, int i, Bundle bundle) throws Throwable {
        ...
        return invokeExecStartActivity(mBaseInstrumentation,Context.class,IBinder.class,IBinder.class,Activity.class,Intent.class,Integer.TYPE,Bundle.class).callByCaller(mBaseInstrumentation, new Object[]{context, binder, binder1, activity, intent, Integer.valueOf(i), bundle});
    }
    ...
    public ActivityResult execStartActivity(Context context, IBinder binder, IBinder binder1, String str, Intent intent, int i, Bundle bundle) throws Throwable {
        if(intent == null) return null;
        return invokeExecStartActivity(mBaseInstrumentation,Context.class,IBinder.class,IBinder.class,String.class,Intent.class,Integer.TYPE,Bundle.class).callByCaller(mBaseInstrumentation, new Object[]{context, binder, binder1, str, intent, Integer.valueOf(i), bundle});
    }
    ...
    public ActivityResult execStartActivity(Context context, IBinder binder, IBinder binder1, Fragment fragment, Intent intent, int i) throws Throwable {
        if(intent == null) return null;
        return invokeExecStartActivity(mBaseInstrumentation,Context.class,IBinder.class,IBinder.class,Fragment.class,Intent.class,Integer.TYPE).callByCaller(mBaseInstrumentation, new Object[]{context, binder, binder1, fragment, intent, Integer.valueOf(i)});
    }
    ...
    public ActivityResult execStartActivity(Context context, IBinder binder, IBinder binder1, Activity activity, Intent intent, int i) throws Throwable {
        if(intent == null) return null;
        return invokeExecStartActivity(mBaseInstrumentation,Context.class,IBinder.class,IBinder.class,Activity.class,Intent.class,Integer.TYPE).callByCaller(mBaseInstrumentation, new Object[]{context, binder, binder1, activity, intent, Integer.valueOf(i)});
    }
    ...
    public ActivityResult execStartActivity(Context context, IBinder binder, IBinder binder1, Fragment fragment, Intent intent, int i, Bundle bundle) throws Throwable {
        if(intent == null) return null;
        return invokeExecStartActivity(mBaseInstrumentation,Context.class,IBinder.class,IBinder.class,Fragment.class,Intent.class,Integer.TYPE,Bundle.class).callByCaller(mBaseInstrumentation, new Object[]{context, binder, binder1, fragment, intent, Integer.valueOf(i), bundle});
    }
    ...
    public ActivityResult execStartActivity(Context context, IBinder iBinder, IBinder iBinder2, Activity activity, Intent intent, int i, Bundle bundle, UserHandle userHandle) throws Throwable {
        if(intent == null) return null;
        return invokeExecStartActivity(mBaseInstrumentation,Context.class,IBinder.class,IBinder.class,Activity.class,Intent.class,Integer.TYPE,Bundle.class,UserHandle.class).callByCaller(mBaseInstrumentation, new Object[]{context, iBinder, iBinder2, activity, intent, Integer.valueOf(i), bundle, userHandle});
    }
